...
<a id="seg" href="indexnar.php" onclick="changeseg()" href="#" style="text-align:center; width: 90px; height: 20px; position:absolute; top: 40px; right:30px; border: none; background:red; z-index:1; text-decoration:none; color: white;">Внутренний</a>
...
<ul id="sub-menu2" style="display:none">
	<a class="design" onclick="toggle(document.getElementById('sub-menu21'))" href="#2"><font color=#A60000>П</font>араметры</a>	
			...
			<li><a class="design" href="#okno">П<font color="#A60000">а</font>раметры TCP IP</a></li>
...
<a class="design" href="#service" ><font color=#A60000>С</font>ервис</a>
	...
	<td><input autofocus type="password" style=":focus; font:14px 'Lucida Console'; background:none; border:none;" name="pass"></input></td>
	</tr>
	</table>
	 </form></center>
	 	<?php $_SESSION['flagadm']=false; $_SESSION['pass']="none"; $_SESSION['pass'] = $_POST["pass"]; 
		if ($_SESSION['pass']=="adm"&&$_SESSION['flagadm']==false)
		{echo '<script>location.replace("indexadmvn.php")</script>'; $_SESSION['flagadm']=true;}
