...
<!--Обработчик нажатий-->
  ...
  if(e.keyCode === 82) {toggle(document.getElementById('sub-menu12'));}
...
//  if(e.keyCode === 83) {document.location.href = "#service";}
  ...
  if(e.keyCode === 114){document.location.href = "indexvn.php";}
  if(e.keyCode === 115){document.location.href = "indexnar.php";}
   if(e.keyCode === 70){document.location.href = "#okno2";}
